...
internal static class Messages
{
    ...
    public static readonly string Dashboard_Apply = nameof(Dashboard_Apply);
    public static readonly string Dashboard_SettingsApplied = nameof(Dashboard_SettingsApplied);
