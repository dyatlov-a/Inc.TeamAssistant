...
internal static class Messages
{
    ...
    public static readonly MessageId Constructor_FeatureAppraiserDescription = new(nameof(Constructor_FeatureAppraiserDescription));
    public static readonly MessageId Constructor_FeatureReviewerDescription = new(nameof(Constructor_FeatureReviewerDescription));
    public static readonly MessageId Constructor_FeatureRandomCoffeeDescription = new(nameof(Constructor_FeatureRandomCoffeeDescription));
    public static readonly MessageId Constructor_FeatureCheckInDescription = new(nameof(Constructor_FeatureCheckInDescription));
    ...
    public static readonly MessageId Constructor_FormSectionSetSettingsRoundRobinDescription = new(nameof(Constructor_FormSectionSetSettingsRoundRobinDescription));
    public static readonly MessageId Constructor_FormSectionSetSettingsRandomDescription = new(nameof(Constructor_FormSectionSetSettingsRandomDescription));
    public static readonly MessageId Constructor_FormSectionSetSettingsAppraiserHeader = new(nameof(Constructor_FormSectionSetSettingsAppraiserHeader));
    public static readonly MessageId Constructor_FormSectionSetSettingsAppraiserHelp = new(nameof(Constructor_FormSectionSetSettingsAppraiserHelp));
    public static readonly MessageId Constructor_FormSectionSetSettingsStoryTypeFieldLabel = new(nameof(Constructor_FormSectionSetSettingsStoryTypeFieldLabel));
    public static readonly MessageId Constructor_FormSectionSetSettingsReviewerHeader = new(nameof(Constructor_FormSectionSetSettingsReviewerHeader));
    public static readonly MessageId Constructor_FormSectionSetSettingsReviewerHelp = new(nameof(Constructor_FormSectionSetSettingsReviewerHelp));
    public static readonly MessageId Constructor_FormSectionSetSettingsNextReviewerStrategyFieldLabel = new(nameof(Constructor_FormSectionSetSettingsNextReviewerStrategyFieldLabel));
