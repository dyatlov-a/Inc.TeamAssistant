...
{
    Task<GetIntegrationPropertiesResult> GetTeamProperties(Guid teamId, CancellationToken token = default);
    
    Task SetTeamProperties(SetIntegrationPropertiesCommand command, CancellationToken token = default);
