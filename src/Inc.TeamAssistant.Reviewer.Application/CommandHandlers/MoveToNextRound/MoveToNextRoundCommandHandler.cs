...
internal sealed class MoveToNextRoundCommandHandler : IRequestHandler<MoveToNextRoundCommand>
{
    ...
    public async Task Handle(MoveToNextRoundCommand command, CancellationToken cancellationToken)
    {
        if (command is null)
